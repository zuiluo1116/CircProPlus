...
use Bio::SeqIO;
use Bio::Perl;
my ($circ_in, $out, $ref_file, $gtf, $help, $species, $max_thread, $ribo_adaptor, $ribo_in, $rrna_file, $overlap_len, $dont_remove_temp);
...
';
	...
	# system "bwa index -a bwtsw $ref_file"; ## you're totally crazy when you try to create index EVERYTIME you're running exactly SAME reference!!!! 
        ...
        if($check == 0){
          ...
          system "echo $out/temp/CIRIerror.log";
          exit;
        }
        close(IN1);
...
#        print "Done!\n";
        ...
        print "CPAT Running ...\n";
        system "cpat -g $out/circRNA.fa -x /user/public/circpro/CPAT_dat/Mouse_Hexamer.tsv -d /user/public/circpro/CPAT_dat/Mouse_logitModel.RData --top-orf=5 -o $out/CPAT";
        print "Done!\n";
